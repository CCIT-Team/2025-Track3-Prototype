...
/// </summary>
public class TerrainRaiseManager2 : MonoBehaviour
{
    [Header("Terrain 참조")]
    ...
    private void BakeTerrainFromParticles()
    {
        ...
        foreach (var go in _stopped)
        {
            ...
            var sp = go.GetComponent<SoilParticle2>();
    ...
    private void PaintTerrainFromParticles()
    {
        ...
        foreach (var go in _stopped)
        {
            ...
            var layer = go.GetComponent<SoilParticle2>()?.GetLayer();
            ...
            float radius = go.GetComponent<SoilParticle2>()?.bakeRadius ?? 0f;
            radius *= 1.5f;
            int rX = Mathf.CeilToInt(radius / cellSizeX);
            int rZ = Mathf.CeilToInt(radius / cellSizeZ);
