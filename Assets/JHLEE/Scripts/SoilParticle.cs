...
/// <summary>
/// Represents a soil particle with friction, stopping conditions, and baking behavior.
/// When at rest, registers with TerrainRaiseManager for terrain baking.
/// </summary>
...
public class SoilParticle : MonoBehaviour
{
    ...
    private TerrainRaiseManager _raiseManager;
    ...
    void Awake()
    {
        ...
        _raiseManager = FindObjectOfType<TerrainRaiseManager>();
    }
